#Carpeta:4.-operadores en python-> 7.-operadores logicos
...
#not devuelve True si alguno de los operandos son falsos basicamente invierte el valor de la exprecion
resultado = not a
print(resultado)